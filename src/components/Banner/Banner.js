        ...
        <div className="right-container">
          ...
          <div>
            ...
            <ul className="list-container">
              ...
              <li>
                C..I. is the highest contributor in the country for the projects
                of EEL (Energy Efficiency Services Limited) to replace the old
                inefficient pumps with 5 Star rated energy efficient smart pumps
                with IT enabled control panel.
              </li>
            </ul>
          </div>
          ...
          <p>
            ...
            Selvaraj, Joint Managing Director of C..I. Group received the award
